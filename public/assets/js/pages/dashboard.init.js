...
var barchartColors = getChartColorsArray("#mini-chart5");
var options = {
  series: [30, 55],
  chart: {
    type: 'donut',
...
var barchartColors = getChartColorsArray("#mini-chart6");
var options = {
  series: [30, 55],
  chart: {
    type: 'donut',
...
var barchartColors = getChartColorsArray("#mini-chart7");
var options = {
  series: [30, 55],
  chart: {
    type: 'donut',
...
var barchartColors = getChartColorsArray("#mini-chart8");
var options = {
  series: [30, 55],
  chart: {
    type: 'donut',
